...
{
    public partial class tbBaseCalculosHistorial
    {
        public int hbas_Id { get; set; }
        ...
        public int? hbas_UsuarioAccion { get; set; }
        public DateTime? hbas_FechaAccion { get; set; }
        public string hbas_Accion { get; set; }
    }
}