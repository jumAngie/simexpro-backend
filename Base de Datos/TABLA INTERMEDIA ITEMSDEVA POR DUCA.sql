...
CREATE TABLE Adua.tbItemsDEVAPorDuca (
		...
		CONSTRAINT FK_Adua_tbItemsDEVAPorDuca_duca_No_DUCA_Adua_tbDuca_duca_No_Duca			FOREIGN KEY (duca_No_DUCA)  REFERENCES Adua.tbDuca (duca_No_DUCA),
...
BEGIN
	BEGIN TRY	
			BEGIN
				INSERT INTO Adua.tbItemsDEVAPorDuca (duca_No_DUCA, deva_Id, usua_UsuarioCreacion, dedu_FechaCreacion)
				     VALUES							(@duca_No_DUCA, @deva_Id, @usua_UsuarioCreacion, @dedu_FechaCreacion )
				     SELECT  1
			END
	END TRY
	BEGIN CATCH
