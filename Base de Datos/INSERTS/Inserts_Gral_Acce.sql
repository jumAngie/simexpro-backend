...
VALUES('Kilogramo Neto',			1, GETDATE(),1,1), 
	  ...
	  ('Millar Pulgada Cuadrada',	1, GETDATE(),1,1), 
...
INSERT INTO [Gral].[tbPaises] ([pais_Codigo], [pais_Nombre], [pais_EsAduana],[pais_prefijo] ,[usua_UsuarioCreacion], [pais_FechaCreacion])
VALUES	('AD', 'ANDORRA',					1,'+504', 1, GETDATE()),
		('AE', 'EMIRATOS ARABES UNIDOS',	1,'+504', 1, GETDATE()),
		('AF', 'AFGANISTAN',				1,'+504', 1, GETDATE()),
		('AG', 'ANTIGUA Y BARBUDA',			1,'+504', 1, GETDATE()),
		('AI', 'ANGUILLA',					1,'+504', 1, GETDATE()),
		('AL', 'ALBANIA',					1,'+504', 1, GETDATE()),
		('AM', 'ARMENIA',					1,'+504', 1, GETDATE()),
		('AN', 'ANTILLAS HOLANDESAS',		1,'+504', 1, GETDATE()),
		('AO', 'ANGOLA',					1,'+504', 1, GETDATE()),
		('AQ', 'ANTARTIDA',					1,'+504', 1, GETDATE()),
		('AR', 'ARGENTINA',					1,'+504', 1, GETDATE()),
		('AS', 'SAMOA AMERICANA',			1,'+504', 1, GETDATE()),
		('AT', 'AUSTRIA',					1,'+504', 1, GETDATE()),
		('AU', 'AUSTRALIA',					1,'+504', 1, GETDATE()),
		('AW', 'ARUBA',						1,'+504', 1, GETDATE()),
		('AX', 'ALAND, ISLAS',				1,'+504', 1, GETDATE()),
		('AZ', 'AZERBALIAN',				1,'+504', 1, GETDATE()),
		('BA', 'BOSNIA Y HERZSEGOVINA',		1,'+504', 1, GETDATE()),
		('BB', 'BARBADOS',					1,'+504', 1, GETDATE()),
		('BD', 'BANGLADESH',				1,'+504', 1, GETDATE()),
		('BE', 'BELGICA',					1,'+504', 1, GETDATE()),
		('BF', 'BURKINA FASO',				1,'+504', 1, GETDATE()),
		('BG', 'BULGARIA',					1,'+504', 1, GETDATE()),
		('BH', 'BAHREIN',					1,'+504', 1, GETDATE()),
		('BI', 'BURUNDI',					1,'+504', 1, GETDATE()),
		('BJ', 'BENIN',						1,'+504', 1, GETDATE()),
		('BL', 'SAINT BARTHELEMY',			1,'+504', 1, GETDATE()),
		('BM', 'BERMUDA',					1,'+504', 1, GETDATE()),
		('BN', 'BRUNEI DARUSSALAM',			1,'+504', 1, GETDATE()),
		('BO', 'BOLIVIA',					1,'+504', 1, GETDATE()),
		('BQ', 'BONAIRE, SINT EUSTATIUS AND SABA','+504', 0, 1, GETDATE()),
		('BR', 'BRASIL',					1,'+504', 1, GETDATE()),
		('BS', 'BAHAMAS',					1,'+504', 1, GETDATE()),
		('BT', 'BUTAN',						1,'+504', 1, GETDATE()),
		('BV', 'BOUVET, ISLA',				1,'+504', 1, GETDATE()),
		('BW', 'BOTSWANA',					1,'+504', 1, GETDATE()),
		('BY', 'BIELORRUSIA',				1,'+504', 1, GETDATE()),
		('BZ', 'BELICE',					1,'+504', 1, GETDATE()),
		('CA', 'CANADA',					1,'+504', 1, GETDATE()),
		('CC', 'COCOS (KEELING) ISLAS',		1,'+504', 1, GETDATE()),
		('CD', 'CONGO, REPUBLICA DEMOCRATICA', 0,'+504', 1, GETDATE()),
		('CF', 'CENTROAFRICANA, REPUBLICA', 1,'+504', 1, GETDATE()),
		('CG', 'CONGO, REP. POPULAR DEL',	1,'+504', 1, GETDATE()),
		('CH', 'SUIZA',						1,'+504', 1, GETDATE()),
		('CI', 'COSTA DE MARFIL (COTE D''IVOIRE)', 0,'+504', 1, GETDATE()),
		('CK', 'COOK ISLAS',				1,'+504', 1, GETDATE()),
		('CL', 'CHILE',						1,'+504', 1, GETDATE()),
		('CM', 'CAMERUN',					1,'+504', 1, GETDATE()),
		('CN', 'CHINA',						1,'+504', 1, GETDATE()),
		('CO', 'COLOMBIA',					1,'+504', 1, GETDATE()),
		('CR', 'COSTA RICA',				1,'+504', 1, GETDATE()),
		('CU', 'CUBA',						1,'+504', 1, GETDATE()),
		('CV', 'CABO VERDE',				1,'+504', 1, GETDATE()),
		('CW', 'CURAZAO',					1,'+504', 1, GETDATE()),
		('CX', 'NAVIDAD, ISLAS',			1,'+504', 1, GETDATE()),
		('CY', 'CHIPRE',					1,'+504', 1, GETDATE()),
		('CZ', 'CHECA, REPUBLICA',			1,'+504', 1, GETDATE()),
		('DE', 'ALEMANIA, REPUBLICA FEDERAL', 0,'+504', 1, GETDATE()),
		('DJ', 'DJIBOUTH',					1,'+504', 1, GETDATE()),
		('DK', 'DINAMARCA',					1,'+504', 1, GETDATE()),
		('DM', 'DOMINICA',					1,'+504', 1, GETDATE()),
		('DO', 'DOMINICANA, REPUBLICA',		1,'+504', 1, GETDATE()),
		('DZ', 'ARGELIA',					1,'+504', 1, GETDATE()),
		('EC', 'ECUADOR',					1,'+504', 1, GETDATE()),
		('EE', 'ESTONIA',					1,'+504', 1, GETDATE()),
		('EG', 'EGIPTO',					1,'+504', 1, GETDATE()),
		('EH', 'SAHARA DEL OESTE',			1,'+504', 1, GETDATE()),
		('ER', 'ERITREA',					1,'+504', 1, GETDATE()),
		('ES', 'ESPAÑA',					1,'+504', 1, GETDATE()),
		('ET', 'ETIOPIA',					1,'+504', 1, GETDATE()),
		('FI', 'FINLANDIA',					1,'+504', 1, GETDATE()),
		('FJ', 'FIJI',						1,'+504', 1, GETDATE()),
		('FK', 'FALKLAND ISLAS (MALVINAS)', 1,'+504', 1, GETDATE()),
		('FM', 'MICRONESIA,ESTADO FEDERAL DE', 0,'+504', 1, GETDATE()),
		('FO', 'FAROE, ISLAS',				1,'+504', 1, GETDATE()),
		('FR', 'FRANCIA',					1,'+504', 1, GETDATE()),
		('GA', 'GABON',						1,'+504', 1, GETDATE()),
		('GB', 'REINO UNIDO (INGLATERRA, IRLANDA NORTE, ESCOCIA, GALES)', 0,'+504', 1, GETDATE()),
		('GD', 'GRENADA',					1,'+504', 1, GETDATE()),
		('GE', 'GEORGIA',					1,'+504', 1, GETDATE()),
		('GF', 'FRANCESA,GUINEA',			1,'+504', 1, GETDATE()),
		('GH', 'GHANA',						1,'+504', 1, GETDATE()),
		('GI', 'GIBRALTAR',					1,'+504', 1, GETDATE()),
		('GL', 'GROENLANDIA',				1,'+504', 1, GETDATE()),
		('GM', 'GAMBIA',					1,'+504', 1, GETDATE()),
		('GN', 'GUINEA',					1,'+504', 1, GETDATE()),
		('GP', 'GUADALUPE',					1,'+504', 1, GETDATE()),
		('GQ', 'ECUATORIAL, GUINEA',		1,'+504', 1, GETDATE()),
		('GR', 'GRECIA',					1,'+504', 1, GETDATE()),
		('GS', 'GEORGIA DEL SUR E ISLAS SAND', 0,'+504', 1, GETDATE()),
		('GT', 'GUATEMALA',					1,'+504', 1, GETDATE()),
		('GU', 'GUAN',						1,'+504', 1, GETDATE()),
		('GW', 'GUINEA-BISSAU',				1,'+504', 1, GETDATE()),
		('GY', 'GUYANA (ANTIGUA GUYANA INGLESA', 0,'+504', 1, GETDATE()),
		('HK', 'HONG KONG',					1,'+504', 1, GETDATE()),
		('HM', 'HEARD Y MC DONALD ISLAS',	1,'+504', 1, GETDATE()),
		('HN', 'HONDURAS',					1,'+504', 1, GETDATE()),
		('HR', 'CROACIA',					1,'+504', 1, GETDATE()),
		('HT', 'HAITI',						1,'+504', 1, GETDATE()),
		('HU', 'HUNGRIA',					1,'+504', 1, GETDATE()),
		('ID', 'INDONESIA',					1,'+504', 1, GETDATE()),
		('IE', 'IRLANDA',					1,'+504', 1, GETDATE()),
		('IL', 'ISRAEL',					1,'+504', 1, GETDATE()),
		('IN', 'INDIA',						1,'+504', 1, GETDATE()),
		('IO', 'TERRITORIO BRITANICO DEL OCEANO INDICO', 0,'+504', 1, GETDATE()),
		('IQ', 'IRAQ',						1,'+504', 1, GETDATE()),
		('IR', 'IRAN, REPUBLICA ISLAMICA',	1,'+504', 1, GETDATE()),
		('IS', 'ISLANDIA',					1,'+504', 1, GETDATE()),
		('IT', 'ITALIA',					1,'+504', 1, GETDATE()),
		('JM', 'JAMAICA',					1,'+504', 1, GETDATE()),
		('JO', 'JORDANIA',					1,'+504', 1, GETDATE()),
		('JP', 'JAPON',						1,'+504', 1, GETDATE()),
		('KE', 'KENIA',						1,'+504', 1, GETDATE()),
		('KG', 'KIRGHIZISTAN',				1,'+504', 1, GETDATE()),
		('KH', 'CAMBOYA',					1,'+504', 1, GETDATE()),
		('KI', 'KIRIBATI',					1,'+504', 1, GETDATE()),
		('KM', 'COMORES',					1,'+504', 1, GETDATE()),
		('KN', 'SAINT KITTS AND NEVIS',		1,'+504', 1, GETDATE()),
		('KP', 'KOREA, REP. POPULAR DEMOCRATICA',	0,'+504', 1, GETDATE()),
		('KR', 'KOREA, REP. DE (KOREA DEL SUR)',	0,'+504', 1, GETDATE()),
		('KW', 'KUWAIT',					1,'+504', 1, GETDATE()),
		('KY', 'CAIMAN ISLAS',				1,'+504', 1, GETDATE()),
		('KZ', 'KAZAKSTAN',					1,'+504', 1, GETDATE()),
		('LA', 'LAOS, REPUBLICA POPULAR DEMOCRATICA', 0,'+504', 1, GETDATE()),
		('LB', 'LIBANO',					 1,'+504', 1, GETDATE()),
		('LC', 'SANTA LUCIA',				 1,'+504', 1, GETDATE()),
		('LI', 'LIECHTENSTEIN',				 1,'+504', 1, GETDATE()),
		('LK', 'SRI LANKA (CEILAN)',		 1,'+504', 1, GETDATE()),
		('LR', 'LIBERIA',					 1,'+504', 1, GETDATE()),
		('LS', 'LESOTHO',					 1,'+504', 1, GETDATE()),
		('LT', 'LITUANIA',					 1,'+504', 1, GETDATE()),
		('LU', 'LUXEMBURGO',				 1,'+504', 1, GETDATE()),
		('LV', 'LETONIA',					 1,'+504', 1, GETDATE()),
		('LY', 'LIBIA ARABE JAMAHIRIYA',	 1,'+504', 1, GETDATE()),
		('MA', 'MARRUECOS',					 1,'+504', 1, GETDATE()),
		('MC', 'MONACO',					 1,'+504', 1, GETDATE()),
		('MD', 'MOLDAVIA, REPUBLICA DE',	 1,'+504', 1, GETDATE()),
		('ME', 'MONTENEGRO',				 1,'+504', 1, GETDATE()),
		('MF', 'SAINT MARTIN (FRENCH PART)', 1,'+504', 1, GETDATE()),
		('MG', 'MADAGASCAR',				 1,'+504', 1, GETDATE()),
		('MH', 'MARSHALL, ISLAS',			 1,'+504', 1, GETDATE()),
		('MK', 'MACEDONIA, LA ANT.REP.DE YUGOS', 0,'+504', 1, GETDATE()),
		('ML', 'MALI',						1,'+504', 1, GETDATE()),
		('MM', 'MYANMAR (ANTIGUA REP. DE BIRMANIA)', 1,'+504', 1, GETDATE()),
		('MN', 'MONGOLIA',					0,'+504', 1, GETDATE()),
		('MO', 'MACAU',						0,'+504', 1, GETDATE()),
		('MP', 'MARIANAS SEPTENTRIONALES, ISLAS', 0,'+504', 1, GETDATE()),
		('MQ', 'MARTINICA',					1,'+504', 1, GETDATE()),
		('MR', 'MAURITANIA',				1,'+504', 1, GETDATE()),
		('MS', 'MONTSERRAT',				1,'+504', 1, GETDATE()),
		('MT', 'MALTA',						1,'+504', 1, GETDATE()),
		('MU', 'MAURICIOS',					1,'+504', 1, GETDATE()),
		('MV', 'MALDIVAS',					1,'+504', 1, GETDATE()),
		('MW', 'MALAWI',					1,'+504', 1, GETDATE()),
		('MX', 'MEXICO',					1,'+504', 1, GETDATE()),
		('MY', 'MALASIA',					1,'+504', 1, GETDATE()),
		('MZ', 'MOZAMBIQUE',				1,'+504', 1, GETDATE()),
		('NA', 'NAMIBIA',					1,'+504', 1, GETDATE()),
		('NC', 'NUEVA CALEDONIA',			1,'+504', 1, GETDATE()),
		('NE', 'NIGER',						1,'+504', 1, GETDATE()),
		('NF', 'NORFOLK, ISLAS',			1,'+504', 1, GETDATE()),
		('NG', 'NIGERIA',					1,'+504', 1, GETDATE()),
		('NI', 'NICARAGUA',					1,'+504', 1, GETDATE()),
		('NL', 'PAISES BAJOS',				1,'+504', 1, GETDATE()),
		('NO', 'NORUEGA',					1,'+504', 1, GETDATE()),
		('NP', 'NEPAL',						1,'+504', 1, GETDATE()),
		('NR', 'NAURO',						1,'+504', 1, GETDATE()),
		('NU', 'NIUE',						1,'+504', 1, GETDATE()),
		('NZ', 'NUEVA ZELANDA',				1,'+504', 1, GETDATE()),
		('OM', 'OMAN',						1,'+504', 1, GETDATE()),
		('PA', 'PANAMA',					1,'+504', 1, GETDATE()),
		('PE', 'PERU',						1,'+504', 1, GETDATE()),
		('PF', 'FRANCESA POLINESIA',		1,'+504', 1, GETDATE()),
		('PG', 'PAPUA NUEVA GUINEA',		1,'+504', 1, GETDATE()),
		('PH', 'FILIPINAS',					1,'+504', 1, GETDATE()),
		('PK', 'PAKISTAN',					1,'+504', 1, GETDATE()),
		('PL', 'POLONIA',					1,'+504', 1, GETDATE()),
		('PM', 'SAN PEDRO Y MIGUELON',		1,'+504', 1, GETDATE()),
		('PN', 'PITCAIRN',					1,'+504', 1, GETDATE()),
		('PR', 'PUERTO RICO',				1,'+504', 1, GETDATE()),
		('PS', 'TERRITORIO PALESTINO OCUPADO', 0,'+504', 1, GETDATE()),
		('PT', 'PORTUGAL',					1,'+504', 1, GETDATE()),
		('PW', 'PALAU',						1,'+504', 1, GETDATE()),
		('PY', 'PARAGUAY',					1,'+504', 1, GETDATE()),
		('QA', 'QATAR',						1,'+504', 1, GETDATE()),
		('RE', 'REUNION',					1,'+504', 1, GETDATE()),
		('RO', 'RUMANIA',					1,'+504', 1, GETDATE()),
		('RS', 'SERBIA',					1,'+504', 1, GETDATE()),
		('RU', 'RUSA, FEDERACION',			1,'+504', 1, GETDATE()),
		('RW', 'RUANDA',					1,'+504', 1, GETDATE()),
		('SA', 'SAUDITA ARABIA',			1,'+504', 1, GETDATE()),
		('SB', 'SOLOMON, ISLAS',			1,'+504', 1, GETDATE()),
		('SC', 'SEYCHELLES, ISLAS',			1,'+504', 1, GETDATE()),
		('SD', 'SUDAN',						1,'+504', 1, GETDATE()),
		('SE', 'SUECIA',					1,'+504', 1, GETDATE()),
		('SG', 'SINGAPUR',					1,'+504', 1, GETDATE()),
		('SH', 'SANTA HELENA',				1,'+504', 1, GETDATE()),
		('SI', 'ESLOVENIA',					1,'+504', 1, GETDATE()),
		('SJ', 'SVALBARD AND JAN MAYEN ISLAS', 0,'+504', 1, GETDATE()),
		('SK', 'ESLOVAKIA',					1,'+504', 1, GETDATE()),
		('SL', 'SIERRA LEONA',				1,'+504', 1, GETDATE()),
		('SM', 'SAN MARINO',				1,'+504', 1, GETDATE()),
		('SN', 'SENEGAL',					1,'+504', 1, GETDATE()),
		('SO', 'SOMALIA',					1,'+504', 1, GETDATE()),
		('SR', 'SURINAM (GUAYANA HOLANDESAS)', 0,'+504', 1, GETDATE()),
		('SS', 'SUDAN DEL SUR',				1,'+504', 1, GETDATE()),
		('ST', 'SAO TOME Y PRINCIPE',		1,'+504', 1, GETDATE()),
		('SV', 'EL SALVADOR',				1,'+504', 1, GETDATE()),
		('SX', 'SINT MAARTEN (DUTCH PART)', 1,'+504', 1, GETDATE()),
		('SY', 'SIRIA, REPUBLICA ARABE',	1,'+504', 1, GETDATE()),
		('SZ', 'SUAZILANDIA',				1,'+504', 1, GETDATE()),
		('TC', 'TURCOS Y CAICOS ISLAS',		1,'+504', 1, GETDATE()),
		('TD', 'CHAD',						1,'+504', 1, GETDATE()),
		('TF', 'FRANCESES, TERRITORIOS DEL SURESTE', 0,'+504', 1, GETDATE()),
		('TG', 'TOGO',						 1,'+504', 1, GETDATE()),
		('TH', 'TAILANDIA',					 1,'+504', 1, GETDATE()),
		('TJ', 'TADJIKISTAN',				 1,'+504', 1, GETDATE()),
		('TK', 'TOKELAU',					 1,'+504', 1, GETDATE()),
		('TL', 'TIMOR DEL ESTE',			 1,'+504', 1, GETDATE()),
		('TM', 'TURKMENISTAN',				 1,'+504', 1, GETDATE()),
		('TN', 'TUNISIA',					 1,'+504', 1, GETDATE()),
		('TO', 'TONGA',						 1,'+504', 1, GETDATE()),
		('TR', 'TURQUIA',					 1,'+504', 1, GETDATE()),
		('TT', 'TRINIDAD Y TOBAGO',			 1,'+504', 1, GETDATE()),
		('TV', 'TUVALU',					 1,'+504', 1, GETDATE()),
		('TW', 'TAIWAN, PROVINCIA CHINA DE', 1,'+504', 1, GETDATE()),
		('TZ', 'TANZANIA, REPUBLICA UNIDA DE', 0,'+504', 1, GETDATE()),
		('UA', 'UCRANIA',					1,'+504', 1, GETDATE()),
		('UG', 'UGANDA',					1,'+504', 1, GETDATE()),
		('UM', 'ISLAS ULTRAMARINAS MENORES (EEUU)', 0,'+504', 1, GETDATE()),
		('US', 'ESTADOS UNIDOS',			1,'+504', 1, GETDATE()),
		('UY', 'URUGUAY',					1,'+504', 1, GETDATE()),
		('UZ', 'UZBEKISTAN',				1,'+504', 1, GETDATE()),
		('VA', 'SANTA SEDE (CIUDAD DEL VATICANO)', 0,'+504', 1, GETDATE()),
		('VC', 'SAN VICENTE Y LAS GRANADINAS', 0,'+504', 1, GETDATE()),
		('VE', 'VENEZUELA',					1,'+504', 1, GETDATE()),
		('VG', 'VIRGENES, ISLAS (BRITANICAS)', 0,'+504', 1, GETDATE()),
		('VI', 'VIRGENES, ISLAS (ESTADOS UNIDOS)', 0,'+504', 1, GETDATE()),
		('VN', 'VIETNAM',					1,'+504', 1, GETDATE()),
		('VU', 'VANUATU',					1,'+504', 1, GETDATE()),
		('WF', 'WALLIS Y FUTUNA, ISLAS',	1,'+504', 1, GETDATE()),
		('WS', 'SAMOA',						1,'+504', 1, GETDATE()),
		('YE', 'YEMEN',						1,'+504', 1, GETDATE()),
		('YT', 'MAYOTTE',					1,'+504', 1, GETDATE()),
		('ZA', 'SURAFRICA',					1,'+504', 1, GETDATE()),
		('ZM', 'ZAMBIA',					1,'+504', 1, GETDATE()),
		('ZW', 'ZIMBABWE',					1,'+504', 1, GETDATE()),
		('HN', 'HONDURAS',					0,'+504', 1, GETDATE()),
		('US', 'ESTADOS UNIDOS',			0,'+504', 1, GETDATE()),
		('SV', 'EL SALVADOR',				0,'+504', 1, GETDATE()),
		('SE', 'SUECIA',					0,'+504', 1, GETDATE()),
		('PR', 'PUERTO RICO',				0,'+504', 1, GETDATE()),
		('PE', 'PERU',						0,'+504', 1, GETDATE()),
		('PA', 'PANAMA',					0,'+504', 1, GETDATE()),
		('MX', 'MEXICO',					0,'+504', 1, GETDATE()),
		('GT', 'GUATEMALA',					0,'+504', 1, GETDATE()),
		('CR', 'COSTA RICA',				0,'+504', 1, GETDATE()),
		('AR', 'ARGENTINA',					0,'+504', 1, GETDATE());
