...
CREATE OR ALTER PROCEDURE Prod.UDP_tbFacturasExportacion_Insertar --'230011011994J', '09/21/2023', 168, 3, '09/21/2023'
...
CREATE OR ALTER PROCEDURE Prod.UDP_tbFacturasExportacion_Editar --48, '230011011994J', '09/21/2023', 173, 3, '09/21/2023'
	@faex_Id					INT, 
	@duca_No_Duca				NVARCHAR(100), 
	@faex_Fecha					DATETIME, 
	@orco_Id					INT,   
...
CREATE OR ALTER PROCEDURE Prod.UDP_ComprobarNoDUCA --'230011011994J'
	@duca_No_Duca NVARCHAR(100)
AS
BEGIN
	BEGIN TRY
